...
table tr td{ border-bottom:1px solid #666666;
border-right: 1px solid #666666;}
table tr th{ border-bottom:2px solid #666666;
border-right: 2px solid #666666;}
</style>
<meta name="viewport" content="width=device-width">
<title>Patients Record of Bed Allocation</title></head>
<body>
<div id="main_wrapper">
<div class="menu">
<ul id="menu">
...
<div id="content">
  <div align="left">
    <h1>Patients Bed Allocation Records
    </h1>
  </div>
  <?php
  include('connect.php');
  ...
  $sta=0;
  $sql="SELECT * FROM oc_record ORDER BY pat_id";
  ...
  <tr>
    ...
    <th align="center" scope="col">Patient's Age</th>
	<th scope="col">Patient's Email</th>
	<th scope="col">Patient's Phone Number</th>
    <th scope="col">Gender</th>
    <th scope="col">Bed Allocated</th>
  ...
  <tr>
    ...
    <td align="center"><?php echo $rows['pat_phone'];  ?></td>
	 <td align="center"><?php echo $rows['gender'];  ?></td>
    <td align="center"><?php echo $rows['bed_name'];  ?></td>
	<td align="left"><?php echo $rows['address'];  ?></td>
