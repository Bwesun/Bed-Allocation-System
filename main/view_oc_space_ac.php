...
<title>Occupied Bed Spaces</title></head>
<body>
<div id="main_wrapper">
<div class="menu">
<ul id="menu">
...
// count more value
$sql5="update beds set status='$view' WHERE bed_id='$id'";
$result5=mysql_query($sql5);
  ...
  <tr>
    ...
    <td><a id="link" href="view_oc_space_ac.php?id=<?php echo $rows['bed_id']; ?>" title="Clear Bed Space">Clear</a></td>
	</tr>
	<?php
	}
	//close connection
